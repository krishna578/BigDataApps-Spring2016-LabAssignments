package com.example.krishnasys.kansasweather;
...
}catch (Exception ex)
{
    ...
    public String getWeatherData() {
        ...
        try {
            ...
            String URI = "http://api.openweathermap.org/data/2.5/weather?id=4684888&units=metric&appid=a149d0dfbedce700edce4a82cccb6c32";
    ...
    public void Send_Notification(String Data)
    {
        try
        {
            int notificationId = 1;
            NotificationCompat.Builder Notify = new NotificationCompat.Builder(this);
            Notify.setContentText(Data + "C");
            Notify.setSmallIcon(R.drawable.ic_stat_name);
            Notify.setContentTitle("Weather of Dallas City");
